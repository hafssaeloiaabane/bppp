# [Banque Populaire - Free Admin Template Built with React and Bootstrap4](https://reduction-admin.github.io/react-reduction/)

![Banque Populaire](public/img/screenshots/reduction-admin.jpg?raw=true 'Banque Populaire')
...
Banque Populaire is built on top of [Create React App](https://github.com/facebook/create-react-app), which means all features that create-react-app supports are available.
